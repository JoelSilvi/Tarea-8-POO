...
public class Tarea8 extends Principal implements ActionListener {

	public JPanel panel = new JPanel();

	public JComboBox<String> jComboBox;
	public JComboBox<String> jComboMes;
	...
	public Tarea8() {
		...
		String[] optionsToChoose = { "Arica y Parinacota", "Tarapacá", "Antofagasta", "Atacama", "Coquimbo",
				"Valparaíso", "Región del Libertador Gral. Bernardo O’Higgins", "Región del Maule", "Región de Ñuble",
		...
		String[] eligeMes = { "ENERO", "FEBRERO", "MARZO", "ABRIL", "MAYO", "JUNIO", "JULIO", "AGOSTO", "SEPTIEMBRE",
		...
		if (e.getSource() == b) {
			JOptionPane.showMessageDialog(null,
					("EL NOMBRE ES:    " + textNombre.getText() + "\nEL RUT ES:    " + textRUT.getText()
							...
							+ textAnio.getText() + " A las    " + textHora.getText()),
					"RESERVA DE HORAS", WIDTH);
